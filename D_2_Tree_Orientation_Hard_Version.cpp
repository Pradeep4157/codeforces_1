...
/*
    ...
    now for this D2 version i need to optimize the leafs part that is going n ^ 3 for differentiating the parent and super parent thing..
...
signed main()
{
    ...
    while (t--)
    {
        ...
        queue<int> leafs;
        vector<vector<int>> set_childs(n);
        for (int i = 0; i < n; i++)
        {
            for (int j = 0; j < n; j++)
            {
